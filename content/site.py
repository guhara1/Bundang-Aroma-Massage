...
NAV = [
    ...
    ("지역별 안내", "/bundang/", [
        ("분당구 전체", "/bundang/"),
        ("분당동", "/bundang/bundang-dong-chuljangmassage/"),
        ("수내동", "/bundang/sunae-dong-chuljangmassage/"),
        ("정자동", "/bundang/jeongja-dong-chuljangmassage/"),
        ("서현동", "/bundang/seohyeon-dong-chuljangmassage/"),
        ("이매동", "/bundang/imae-dong-chuljangmassage/"),
        ("야탑동", "/bundang/yatap-dong-chuljangmassage/"),
        ("금곡동", "/bundang/geumgok-dong-chuljangmassage/"),
        ("구미동", "/bundang/gumi-dong-chuljangmassage/"),
        ("판교동", "/bundang/pangyo-dong-chuljangmassage/"),
        ("삼평동", "/bundang/sampyeong-dong-chuljangmassage/"),
        ("백현동", "/bundang/baekhyeon-dong-chuljangmassage/"),
        ("운중동", "/bundang/unjung-dong-chuljangmassage/"),
    ]),
    ("지하철역별 안내", "/bundang/stations/", [
        ("역 전체", "/bundang/stations/"),
        ("판교역", "/bundang/pangyo-station-chuljangmassage/"),
        ("성남역", "/bundang/seongnam-station-chuljangmassage/"),
        ("정자역", "/bundang/jeongja-station-chuljangmassage/"),
        ("미금역", "/bundang/migeum-station-chuljangmassage/"),
        ("오리역", "/bundang/ori-station-chuljangmassage/"),
        ("서현역", "/bundang/seohyeon-station-chuljangmassage/"),
        ("수내역", "/bundang/sunae-station-chuljangmassage/"),
        ("이매역", "/bundang/imae-station-chuljangmassage/"),
        ("야탑역", "/bundang/yatap-station-chuljangmassage/"),
    ]),
    ("테마별 안내", "/themes/", [
        ("전체 테마", "/themes/"),
        ("스웨디시", "/themes/swedish/"),
